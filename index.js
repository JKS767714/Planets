...
// // solarSystem.forEach(element => {
// //     if(element.name == "Venus"){
// // //         element.moons.push("Endor")
// // //         // console.log(element.moons)
// // //     }
...
// // let pluto = solarSystem.find(element => element.name == "Pluto")
...
// const earth = solarSystem.find(element => element.name == "Earth");
// if(earth){
//     earth.diameter = "7917"
// }
...
// const mercury = solarSystem.find(element => element.name === "Mercury");
// if(mercury) {
...
// const uranus = solarSystem.find(element => element.name == "Uranus");
// if(uranus){
//     const moonIdx = uranus.moons.indexOf("Umbriel")

//     if(moonIdx != 1)
// {
//     uranus.moons[moonIdx] = "Oberon"
// }}



// // 8. Iterate through the solarSystem array and print only the objects that have a ringSystem (where ringSystem: true), 
// // and ignore the others. You want to make a loop that goes over each item in the array, and include an if statement)
